...
struct HandshakeResponse : public Message {
    ...
    MessageType GetType() const override { return MessageType::HandshakeResponse; }
    std::vector<uint8_t> Encode() const override;

    static std::unique_ptr<HandshakeResponse> Decode(const uint8_t* data, size_t length);
};
...
struct AuthResponse : public Message {
    ...
    static std::unique_ptr<AuthResponse> Decode(const uint8_t* data, size_t length);
};
...
struct QueryResponseSchema : public Message {
    ...
    MessageType GetType() const override { return MessageType::QueryResponseSchema; }
    std::vector<uint8_t> Encode() const override;

    static std::unique_ptr<QueryResponseSchema> Decode(const uint8_t* data, size_t length);
};

struct QueryResponseBatch : public Message {
    std::vector<uint8_t> arrow_ipc_batch;

    MessageType GetType() const override { return MessageType::QueryResponseBatch; }
    std::vector<uint8_t> Encode() const override;

    static std::unique_ptr<QueryResponseBatch> Decode(const uint8_t* data, size_t length);
};
...
struct QueryComplete : public Message {
    ...
    static std::unique_ptr<QueryComplete> Decode(const uint8_t* data, size_t length);
};
...
struct ErrorMessage : public Message {
    ...
    static std::unique_ptr<ErrorMessage> Decode(const uint8_t* data, size_t length);
};
...
public:
    ...
    static void PutOptionalString(std::vector<uint8_t>& buf, const std::string& str);
    static void PutBytes(std::vector<uint8_t>& buf, const std::vector<uint8_t>& bytes);
