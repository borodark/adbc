defmodule Adbc.Driver do
  ...
  # Generated by update.exs at 2026-01-09T21:22:30. Do not change manually.
  ...
  @generated_driver_data %{
    ...
    cube: %{
      "x86_64-linux-gnu" => %{
        url:
          "https://github.com/borodark/adbc_driver_cube/releases/download/v0.1.2/adbc_driver_cube-0.1.2-x86_64-linux-gnu.tar.gz"
      }
    },
    sqlite: %{
      "aarch64-apple-darwin" => %{
