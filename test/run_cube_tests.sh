...
echo -e "${GREEN}======================================${NC}"
echo -e "${GREEN}Cube ADBC Driver Tests${NC}"
echo -e "${GREEN}======================================${NC}"
echo ""
...
echo ""
echo -e "${GREEN}Running Cube ADBC tests...${NC}"
echo ""
...
if [ "$1" == "--verbose" ] || [ "$1" == "-v" ]; then
    mix test test/adbc_cube_test.exs --trace --include cube
else
...
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "${GREEN}✅ All Cube tests passed!${NC}"
else
